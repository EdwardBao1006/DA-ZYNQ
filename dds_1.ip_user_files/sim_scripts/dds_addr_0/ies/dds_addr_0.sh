...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../dds_1.srcs/sources_1/ip/dds_addr_0/dds_addr.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.dds_addr_0 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.dds_addr_0 -input simulate.do
}
# Script usage
usage()
{
