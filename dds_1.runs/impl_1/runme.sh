...
HD_PWD='F:/hard_projects/wave_producer/dds_1/dds_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_main.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dds_main.tcl -notrace
