...
HD_PWD='F:/hard_projects/wave_producer/dds_1/dds_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dds_main.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dds_main.tcl
